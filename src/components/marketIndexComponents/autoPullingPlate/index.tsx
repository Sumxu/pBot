...
const AutoPullingPlate: React.FC = () => {
  ...
  return (
    <div className="autoPullingPlateBox">
      <Card bodyStyle={{ padding: 14 }}>
        <div className="autoPullingPlateSettingBox">
          <Divider
            orientation="left"
            plain
            style={{
          ...
          >
            ...
            <Switch
              ...
              onChange={(val) => setIsOpenSwitch(val)}
              checked={isOpenSwitch}
            />
          </Divider>
          {isOpenSwitch && (
            <Divider
            ...
            <div>
              ...
              <div className="contentOption">
                <div className="fromOption">
                  ...
                  <Button className="btnLeft12">30%</Button>
                </div>
                ...
                <div className="fromOption">
                  ...
                  <Button className="btnLeft12">3</Button>
                  <Button className="btnLeft12">5</Button>
                  <Button className="btnLeft12">10</Button>
                </div>
              </div>
              ...
              <div className="contentOption">
                <div className="fromOption">
                  ...
                  <Button className="btnLeft12">5s</Button>
                  <Button className="btnLeft12">10s</Button>
                  <Button className="btnLeft12">30s</Button>
                </div>
...
export default AutoPullingPlate;
